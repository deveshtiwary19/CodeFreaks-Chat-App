...
class OreoNotification(base: Context?):ContextWrapper(base)
{
    ...
    companion object
    {
        private const val CHANNEL_ID="com.example.codefreakschatmessenger" //Package name
        private const val CHANNEL_NAME="Codefreaks Chat"                    //App name to display notification With
